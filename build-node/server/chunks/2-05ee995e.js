import { w as writable, d as derived } from './index2-f64d651d.js';
import { g as get_store_value } from './index3-9cccdbaa.js';
...
var N = (s2, t3, e) => t3 in s2 ? H(s2, t3, { enumerable: true, configurable: true, writable: true, value: e }) : s2[t3] = e, l$1 = (s2, t3) => {
  for (var e in t3 || (t3 = {}))
    K.call(t3, e) && N(s2, e, t3[e]);
  if (x)
    for (var e of x(t3))
      A.call(t3, e) && N(s2, e, t3[e]);
  return s2;
}, f$1 = (s2, t3) => q(s2, B(t3));
var L = (s2, t3) => {
  var e = {};
  ...
  if (s2 != null && x)
    for (var a of x(s2))
      t3.indexOf(a) < 0 && A.call(s2, a) && (e[a] = s2[a]);
  return e;
};
...
var z = (n2) => {
  ...
  if (!r)
    return c.warn(`No locale provided for '${t3}' key. Skipping translation...`), "";
  let u2 = (a[r] || {})[t3];
  if (i2 && u2 === void 0 && (c.debug(`No translation provided for '${t3}' key in locale '${r}'. Trying fallback '${i2}'`), u2 = (a[i2] || {})[t3]), u2 === void 0) {
    if (c.debug(`No translation provided for '${t3}' key in fallback '${i2}'.`), o.hasOwnProperty("fallbackValue"))
  ...
  constructor(t3) {
    ...
    this.setLocale = (t4) => {
      if (t4 && t4 !== get_store_value(this.internalLocale))
        return c.debug(`Setting '${t4}' locale.`), this.internalLocale.set(t4), this.loading.toPromise(t4, get_store_value(this.currentRoute));
    };
    this.setRoute = (t4) => {
  ...
  loaders: [
    {
      locale: "fr",
      key: "common",
      loader: async () => (await import('./common-19103847.js')).default
    },
    {
      locale: "fr",
      key: "home",
      routes: ["/"],
      loader: async () => (await import('./home-2c911c75.js')).default
    },
    {
      locale: "fr",
      key: "about",
      routes: ["/about"],
      loader: async () => (await import('./about-fad4cf18.js')).default
    },
    {
      locale: "fr",
      key: "projects",
      routes: ["/projects"],
      loader: async () => (await import('./projects-60e73253.js')).default
    },
    {
      locale: "en",
      key: "common",
      loader: async () => (await import('./common2-b351f3c4.js')).default
    },
    {
      locale: "en",
      key: "home",
      routes: ["/"],
      loader: async () => (await import('./home2-50953c32.js')).default
    },
    {
      locale: "en",
      key: "about",
      routes: ["/about"],
      loader: async () => (await import('./about2-fad4cf18.js')).default
    },
    {
      locale: "en",
      key: "projects",
      routes: ["/projects"],
      loader: async () => (await import('./projects2-60e73253.js')).default
    }
  ]
};
...
const index = 2;
let component_cache;
const component = async () => component_cache ??= (await import('./_layout.svelte-2a9528b8.js')).default;
const universal_id = "src/routes/(portfolio)/+layout.js";
const imports = ["_app/immutable/nodes/2.f3470d20.js","_app/immutable/chunks/index.86d92c49.js","_app/immutable/chunks/preload-helper.a4192956.js","_app/immutable/chunks/index.7f081118.js","_app/immutable/chunks/index.f212c07f.js","_app/immutable/chunks/stores.636a4205.js","_app/immutable/chunks/singletons.00110198.js"];
...
//# sourceMappingURL=2-05ee995e.js.map
